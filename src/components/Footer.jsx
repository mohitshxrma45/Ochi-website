...
const Footer = () => {
    return (
        <div data-scroll data-scroll-section data-scroll-speed=".3"  className='w-full pt-25 pl-15 text-white h-screen flex rounded-tl-2xl rounded-tr-2xl  bg-zinc-900'>
