...
const Footer = () => {
    return (
        <div id='contact' data-scroll data-scroll-section data-scroll-speed=".3"  className='w-full pt-25 pl-15 text-white h-screen flex rounded-tl-2xl rounded-tr-2xl  bg-zinc-900'>
            <div className=' flex flex-col w-1/2 h-full'>
                <div className=' font-[font3] leading-none text-[9vw] h-1/2 '>
                    <h1 className='-mb-7 font-light'>EYE-</h1>
                    <h1 className='-mb-7 font-light'>OPENING</h1>
                </div>
                <div className=' p-5 flex w-full items-end h-1/2'>
            ...
            <div className='w-1/2  h-full'>
                <div className='h-1/4 '>
                    <h1 className=' font-[font3] leading-none text-[9vw] uppercase'> presentations</h1>
                </div>
                <div className='h-1/4 w-full '>
                    <div className='w-1/2 capitalize text-[1.07rem] font-[font5] flex flex-col '>
                        <span>s:</span>
                        <span><p>&nbsp;</p></span>
                        <span>instagram</span>
                        <span>facebook</span>
                ...
                <div className='h-1/4 w-full '>
                    <div className='w-1/2  capitalize text-[1.07rem] font-[font5] flex flex-col   '>
                        ...
                        <span>E:</span>
                        <span><p>&nbsp;</p></span>
                        <span>iammohitpandit52@gmail.com</span>
