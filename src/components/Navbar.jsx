...
const Navbar = () => {
  ...
  return (
    <div className={` fixed z-[999]   w-full px-10 py-8 font-[font4] flex justify-between items-center 
     bg-opacity-60 backdrop-blur-md text-[#CDEA68] transition-transform duration-300
